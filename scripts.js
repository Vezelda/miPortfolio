...
function cambiarIdioma() {
  ...
  const traducciones = {
    'es': {
      ...
      'proyecto3': 'Aplicacion de consulta Api y comandos CLI',
      'proyecto3Desc': 'Aplicacion de consulta API y creacion de comandos CLI, aqui implemente mis conocimientos en Python, Librerias y Backend.',
    ...
    'en': {
      ...
      'proyecto3': 'Api query application and CLI commands',
      'proyecto3Desc': 'API query application and CLI command creation, here implement my knowledge in Python, Libreries and Backend.',
